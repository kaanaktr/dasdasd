...
client.ayarlar = {
  "prefix": "!", //prefix
  "oauthSecret": "E8nsJ-PFGG4dNqQTtGghP0vmCr49AFVR", //bot secreti
	"callbackURL": "https://mrbotlist.glitch.me/callback", //benim sitenin urlsini kendin ile değiş "/callback" kalacak!
	"kayıt": "698191521828044830", //onaylandı, reddedildi, başvuru yapıldı falan kayıtların gideceği kanalın ID'sini yazacaksın
  "renk": "RANDOM" //embedların rengini burdan alıo can sıkıntısdna yapılmış bişe falan fln
};

client.yetkililer = ["366188491199086594", "681872205193150488"] //tüm yetkililerin ıdleri gelcek array
client.webyetkililer = ["366188491199086594", "681872205193150488"] //web yetkililerin ıdleri gelcek array
client.sunucuyetkililer = ["366188491199086594", "681872205193150488"] //sunucu yetkililerin ıdleri gelcek array
...
client.login("NjcxMDI1MDI1NTE1NTIwMDMx.XpCOOQ.FoCZVDUq2-D78s3DEYZkm1FYIf8") //tokeni yaz işte

process.env = {}
process.env.TOKEN = "NjcxMDI1MDI1NTE1NTIwMDMx.XpCOOQ.FoCZVDUq2-D78s3DEYZkm1FYIf8";